...
ThreeStates <- corHMM(tree,tipstate_matrix,2,rate.mat=index.mat,
                     ...
                     ip=c(0.109884809235892,0.106312326151402,0.0469405664596707,0.0379692403451263,0.00423242817694143),nstarts=0,n.cores=1,get.tip.states=FALSE,lewis.asc.bias=FALSE,
                     lower.bound = 1e-9,upper.bound = 100)
save.image("RData_100_Reps/ThreeStates.28.RData")
