...
files=list.files(path="Two_Rates/RData_100_Reps",pattern="*RData")
for (i in 1:length(files)){load(paste("Two_Rates/RData_100_Reps",files[i],sep="/"))}
...
#write
write.table(ML.AIC,"Two_Rates.ML.AIC.txt",quote=FALSE)
