...
ThreeStates <- corHMM(tree,tipstate_matrix,2,rate.mat=index.mat,
                     ...
                     ip=c(0.292987108958845,0.106869907766105,0.0711184521163714,0.00823356993496418,0.00646680819332752),nstarts=0,n.cores=1,get.tip.states=FALSE,lewis.asc.bias=FALSE,
                     lower.bound = 1e-9,upper.bound = 100)
save.image("RData_100_Reps/ThreeStates.54.RData")
