...
ThreeStates <- corHMM(tree,tipstate_matrix,2,rate.mat=index.mat,
                     ...
                     ip=c(0.252490098948095,0.237250174383137,0.0394415955484722,0.0254216923674988,0.00968579120064125),nstarts=0,n.cores=1,get.tip.states=FALSE,lewis.asc.bias=FALSE,
                     lower.bound = 1e-9,upper.bound = 100)
save.image("RData_100_Reps/ThreeStates.53.RData")
