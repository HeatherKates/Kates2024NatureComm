...
ThreeStates <- corHMM(tree,tipstate_matrix,2,rate.mat=index.mat,
                     ...
                     ip=c(0.187368346719632,0.123404264818401,0.115039143674532,0.113835720341177,0.0042102599516511),nstarts=0,n.cores=1,get.tip.states=FALSE,lewis.asc.bias=FALSE,
                     lower.bound = 1e-9,upper.bound = 100)
save.image("RData_100_Reps/ThreeStates.1.RData")
