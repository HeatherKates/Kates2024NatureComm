...
files=list.files(path="Four_Rates/RData_100_Reps",pattern="*RData")
for (i in 1:length(files)){load(paste("Four_Rates/RData_100_Reps",files[i],sep="/"))}
...
#write
write.table(ML.AIC,"Four_Rates.ML.AIC.txt",quote=FALSE)
