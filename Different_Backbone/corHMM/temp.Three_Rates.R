...
files=list.files(path="Three_Rates/RData_100_Reps",pattern="*RData")
for (i in 1:length(files)){load(paste("Three_Rates/RData_100_Reps",files[i],sep="/"))}
...
#write
write.table(ML.AIC,"Three_Rates.ML.AIC.txt",quote=FALSE)
