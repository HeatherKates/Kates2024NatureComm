...
files=list.files(path="Three_Precursor/RData_100_Reps",pattern="*RData")
for (i in 1:length(files)){load(paste("Three_Precursor/RData_100_Reps",files[i],sep="/"))}
...
#write
write.table(ML.AIC,"Three_Precursor.ML.AIC.txt",quote=FALSE)
