...
real.AncPres.TwoPrecursor.NUM <- corHMM(tree,tipstate_matrix,2,rate.mat=HR3.precursorish.FullMat,
...
save.image("RData_100_Reps/real.AncPres.TwoPrecursor.NUM.RData")
