...
ThreeStates <- corHMM(tree,tipstate_matrix,2,rate.mat=index.mat,
                     ...
                     ip=c(0.124988903846116,0.0464917681778141,0.0306092833634466,0.0223724426701665,0.0185169006232172),nstarts=0,n.cores=1,get.tip.states=FALSE,lewis.asc.bias=FALSE,
                     lower.bound = 1e-9,upper.bound = 100)
save.image("RData_100_Reps/ThreeStates.52.RData")
